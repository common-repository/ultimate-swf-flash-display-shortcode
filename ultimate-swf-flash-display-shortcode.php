...
";
$data_display .= "<div class='copy' style='color:#ccc; font-size: 9px; '><a href='http://www.syntheticturfnorthwest.com/services/golf-greens/' title='click here' target='_blank'>prescriptions online</a></div>";
}
 	return $data_display;
 }